...
import madngoding.hammad.moviecatalog.databinding.ListFavTvShowBinding
import madngoding.hammad.moviecatalog.ui.favorite.FavoriteFragmentDirections

class FavoriteTvShowAdapter : PagedListAdapter<TvShowEntity, FavoriteTvShowAdapter.TvShowViewHolder>(TvShowDiffCallback()) {
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): TvShowViewHolder {
        return TvShowViewHolder(
                DataBindingUtil.inflate(
                        LayoutInflater.from(parent.context),
                        R.layout.list_fav_tv_show,
                        parent,
                        false
                )
        )
    ...
    class TvShowViewHolder(private val binding: ListFavTvShowBinding) :
        ...
        private fun navigateToDetail(id: String, view: View) {
            val direction = FavoriteFragmentDirections.actionFavoriteFragmentToTvShowDetailFragment(id)
