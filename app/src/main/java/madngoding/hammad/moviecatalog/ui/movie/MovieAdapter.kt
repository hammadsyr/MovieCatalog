...
import madngoding.hammad.moviecatalog.databinding.ListMovieBinding
import timber.log.Timber

class MovieAdapter : PagedListAdapter<MovieEntity, MovieAdapter.MovieViewHolder>(MovieDiffCallback()) {
    ...
    class MovieViewHolder(private val binding: ListMovieBinding) :
        ...
        private fun navigateToDetail(id: String, view: View) {
            Timber.e(id)
            val direction = MovieFragmentDirections.actionMovieFragmentToMovieDetailFragment(id)
